  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-[128px]">
      ...
      <section className="w-full h-[400px] md:h-[500px]">
        <img 
          src="https://images.unsplash.com/photo-1477093782505-e10ffe6a99b7?w=1200&q=80" 
      ...
      <section className="py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 lg:px-8">
          ...
          <div className="flex justify-center gap-2 mb-6">
             <span className="inline-block bg-primary-pink/10 text-primary-pink px-4 py-1.5 rounded-full text-xs font-semibold capitalize">lifestyle</span>
             <span className="inline-block bg-primary-pink/10 text-primary-pink px-4 py-1.5 rounded-full text-xs font-semibold capitalize">health</span>
          </div>
          ...
          <article className="prose prose-lg max-w-none text-muted leading-relaxed">
             ...
             <blockquote className="italic text-gray-500 border-l-4 border-primary-pink pl-6 py-2 mb-10 bg-light rounded-r-xl">
             ...
             {/* Styled blockquote */}
             <div className="bg-primary-dark rounded-2xl p-10 text-center mb-10 relative mt-16">
               <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-primary-pink rounded-full flex items-center justify-center text-white text-3xl font-serif">
                 "
               </div>
               ...
               <span className="text-primary-pink font-semibold uppercase tracking-wider text-sm">(Larry Brown)</span>
             </div>
          ...
          {/* Author Bio Card */}
          <div className="bg-light rounded-2xl p-8 flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
            <img 
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start gap-3">
                 {/* Social Icons */}
                 <a href="#" className="w-8 h-8 rounded-full bg-primary-pink/10 text-primary-pink flex items-center justify-center hover:bg-primary-pink hover:text-white transition-colors">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-6 mb-16">
            <Link to="#" className="flex items-center gap-4 group">
              <div className="text-primary-pink shrink-0 transition-transform group-hover:-translate-x-1">&larr;</div>
              <span className="font-poppins font-semibold text-primary-dark group-hover:text-primary-pink transition-colors">7 Tips for Effective Practice</span>
            </Link>
            <Link to="#" className="flex items-center justify-end gap-4 group text-right">
              <span className="font-poppins font-semibold text-primary-dark group-hover:text-primary-pink transition-colors">5 reasons to start playing sports</span>
              <div className="text-primary-pink shrink-0 transition-transform group-hover:translate-x-1">&rarr;</div>
            </Link>
          </div>
          ...
          <div className="mb-16">
                ...
                <div key={idx} className={`flex gap-6 ${comment.isReply ? 'ml-12 md:ml-20' : ''}`}>
                  ...
                  <div className="flex-1 bg-light p-6 rounded-2xl rounded-tl-none">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <button className="text-primary-pink text-sm font-medium hover:underline">Reply</button>
                    </div>
            ...
            <div className="text-center mt-10">
              <button className="px-8 py-3 rounded-full border-2 border-primary-pink text-primary-pink font-poppins font-semibold hover:bg-primary-pink hover:text-white transition-colors">
                View More Comments
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <form className="space-y-6">
              ...
              <input type="url" placeholder="Website" className="w-full h-14 px-6 rounded-xl border border-gray-200 focus:outline-none focus:border-primary-pink bg-light" />
              <textarea placeholder="Comment*" rows="6" className="w-full p-6 rounded-xl border border-gray-200 focus:outline-none focus:border-primary-pink bg-light resize-none" required></textarea>
              <button type="submit" className="px-10 py-4 bg-primary-pink text-white rounded-full font-poppins font-semibold hover:bg-[#d44c77] transition-all shadow-md">
                Submit
              </button>
            </form>
          </div>
      ...
      <section className="py-24 bg-light border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-4 lg:px-8">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             ...
             <div className="bg-white rounded-2xl overflow-hidden shadow-sm flex flex-col sm:flex-row-reverse border border-gray-100 group">
                ...
                <div className="flex-1 p-6 flex flex-col justify-center">
                  <span className="text-xs text-primary-pink font-semibold uppercase tracking-wide mb-2">#food</span>
                  <h4 className="font-poppins font-bold text-lg text-primary-dark mb-2 group-hover:text-primary-pink transition-colors">How diet influences flexibility</h4>
             ...
             <div className="bg-white rounded-2xl overflow-hidden shadow-sm flex flex-col sm:flex-row-reverse border border-gray-100 group">
                ...
                <div className="flex-1 p-6 flex flex-col justify-center">
                  <span className="text-xs text-primary-pink font-semibold uppercase tracking-wide mb-2">#lifestyle</span>
                  <h4 className="font-poppins font-bold text-lg text-primary-dark mb-2 group-hover:text-primary-pink transition-colors">7 Tips for Effective Practice</h4>
                  <span className="text-xs text-muted">June 06, 2022</span>
                </div>
             </div>
           </div>
