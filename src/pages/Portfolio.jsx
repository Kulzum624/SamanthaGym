...
export default function Portfolio() {
  ...
  const programs = [
    ...
    { title: "Bodybuilding Localized", img: [img14], featured: true },
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-[120px]">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 flex flex-col lg:flex-row gap-16 items-center">
            ...
            <ul className="space-y-6">
              {[
                ...
                <li key={idx} className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-primary-lime/10 text-primary-lime flex items-center justify-center shrink-0">
          ...
          <div className="w-full lg:w-2/3 flex flex-col sm:flex-row gap-6">
            <img src={img10} alt="Portfolio 1" className="w-full sm:w-1/2 h-[400px] object-cover shadow-lg" />
            <img src={img11} alt="Portfolio 2" className="w-full sm:w-1/2 h-[400px] object-cover shadow-lg" />
          </div>
        </div>
      </section>
      ...
      <section className="relative h-[250px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center max-w-2xl px-4">
          <div className="inline-block bg-primary-lime text-black px-6 py-2 rounded-full font-bold font-poppins text-lg mb-6">
            22 June · 6:30pm
          </div>
          <h3 className="font-poppins font-bold text-3xl md:text-4xl text-white mb-8">Don't miss the next workout</h3>
          <Link to="/schedule" className="text-white font-medium hover:text-primary-lime transition-colors underline decoration-2 underline-offset-4">
            Workout Schedule
          </Link>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <motion.div key={idx} whileHover={{ y: -5 }} className="bg-white p-8 rounded-2xl text-center border border-gray-100 shadow-sm">
              <div className="w-16 h-16 mx-auto bg-primary-lime/10 text-primary-lime rounded-2xl flex items-center justify-center mb-6">
      ...
      <section className="py-24 bg-white text-center px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <ul className="space-y-4 mb-12 text-left md:text-center text-muted">
            <li className="flex items-center justify-center gap-3"><svg className="w-5 h-5 text-primary-lime" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Suspendisse in est ante in nibh mauris cursus mattis.</li>
            <li className="flex items-center justify-center gap-3"><svg className="w-5 h-5 text-primary-lime" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Rutrum tellus pellentesque eu tincidunt tortor aliquam nulla.</li>
            <li className="flex items-center justify-center gap-3"><svg className="w-5 h-5 text-primary-lime" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Feugiat in fermentum posuere urna nec tincidunt praesent.</li>
          </ul>
